...
class FeedingTable(Chair):
    """
    The FeedingTable class represents a chair for feeding a baby, which inherits from the Chair class.
    """

    def __init__(self, id=2, material="wood", max_weight="150", owner="Bob", max_height_chair=100, min_height_chair=60,
